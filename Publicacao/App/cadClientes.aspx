                    ...
                    <table class="tblConteudoForms">
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="btnAcaoJQueryEnd" runat="server" CssClass="finalizarAcaoEnd" OnClick="btnAcaoJQueryEnd_click" Text="" Style="display: none;" />
                                <asp:Button ID="btnAcaoJQueryCnt" runat="server" CssClass="finalizarAcaoCnt" OnClick="btnAcaoJQueryCnt_click" Text="" Style="display: none;" />
                                <asp:Button ID="btnAcaoJQuerySet" runat="server" CssClass="finalizarAcaoSet" OnClick="btnAcaoJQuerySet_click" Text="" Style="display: none;" />
                                <asp:Button ID="btnAcaoJQuerySla" runat="server" CssClass="finalizarAcaoSla" OnClick="btnAcaoJQuerySla_click" Text="" Style="display: none;" />
                                <asp:Button ID="btnAcaoJQueryEqp" runat="server" CssClass="finalizarAcaoEqp" OnClick="btnAcaoJQueryEqp_click" Text="" Style="display: none;" />
