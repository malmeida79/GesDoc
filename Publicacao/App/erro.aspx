<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="erro.aspx.cs" Inherits="GesDoc.Web.App.erro" %>
...
<body class="bodyInterno">
    <form id="form1" runat="server">
                    ...
                    <table class="tblConteudoForms" style="margin-top:25%">
                        <tr>
                            <td class="cellCenter" colspan="2">
                                <asp:Label ID="lblPrincipal" runat="server" Text="" ForeColor="White"></asp:Label>
                                <br /><br />
        ...
        <script type="text/javascript" src="/Scripts/geral_site.js"></script>
    </form>
</body>
</html>
