<%@ Page Title="" Language="C#" MasterPageFile="~/App/Sistema.Master" AutoEventWireup="true" CodeBehind="listaClientes.aspx.cs" Inherits="GesDoc.Web.App.listaClientes" %>
    ...
    <div id="corpoPagina">
        ...
        <asp:GridView CssClass="grids" HorizontalAlign="Center" ID="gdvClientes" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="Groove" BorderWidth="1px" CellPadding="4" Width="50%" AllowPaging="True" OnPageIndexChanging="gdvClientes_PageIndexChanging" AllowSorting="True" AutoGenerateEditButton="True" OnRowEditing="gdvClientes_RowEditing" OnSorting="gdvClientes_Sorting" AutoGenerateColumns="False" OnRowDataBound="gdvClientes_RowDataBound" ForeColor="Black" GridLines="Vertical">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="razaoSocialCliente" HeaderText="Razão Social" SortExpression="razaoSocialCliente" />
                <asp:BoundField DataField="cpfCnpjCliente" HeaderText="CPF / CNPJ" SortExpression="cpfCnpjCliente" DataFormatString="{0:999\.999\.9999\-99}" />
                ...
                <asp:BoundField DataField="deletado" HeaderText="Deletado" SortExpression="delete" />
            </Columns>
